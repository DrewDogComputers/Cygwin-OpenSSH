...
.PARAMETER KeyType
Specifies the key type: dsa, ecdsa, ed25519, or rsa. The default is ed25519.
...
Specifies the number of bits for the key type. The default value for this parameter depends on the -KeyType parameter:
  ...
  ed25519 - this parameter is ignored if -KeyType is ed25519
  rsa - minimum 1024; default is 2048 (values < 2048 not considered secure)
...
param(
  ...
  [ValidateSet("dsa","ecdsa","ed25519","rsa")]
